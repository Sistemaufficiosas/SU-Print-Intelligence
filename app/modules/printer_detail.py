...
from app.modules.interventions import InterventionDialog
...
class PrinterDetailDialog(QDialog):
    ...
    def create_interventions_tab(self) -> QWidget:
        ...
        new_button = QPushButton("＋ Nuovo intervento tecnico")
        new_button.setObjectName("primaryButton")
        new_button.setCursor(Qt.CursorShape.PointingHandCursor)
        new_button.clicked.connect(self.open_intervention_dialog)
    ...
    def open_intervention_dialog(self) -> None:
        """Apre la registrazione di un nuovo intervento tecnico."""
